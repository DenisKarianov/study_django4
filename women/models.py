...
def translit_rus_eng(s: str) -> str:
    d = {
...
class Women(models.Model):
    ...
    slug = models.SlugField(max_length=255, unique=True, db_index=True, verbose_name='Slug',
                            validators=[MinLengthValidator(5, message="Минимум 5 символов"), MaxLengthValidator(100)])
    ...
    #     self.slug = slugify(translit_rus_eng(self.title))
...
class Husband(models.Model):
    ...
    m_count = models.IntegerField(null=True, default=0)
